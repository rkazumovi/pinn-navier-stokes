"""
Network architecture for the 2D unsteady cylinder-flow PINN.

Input:  (x, y, t)       -- 3 features (space + time)
Output: (u, v, p)       -- 3 features (velocity components + pressure)

Same shared-trunk design as the cavity flow model, just one more input
neuron for time. Slightly larger than the cavity network since unsteady
vortex shedding is a harder function to represent.
"""
